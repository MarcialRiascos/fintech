...
export class PerfilService {
  ...
  async actualizarPerfil(
    ...
    usuario.codigo_departamento =
      dto.codigo_departamento ?? usuario.codigo_departamento;
    ...
    usuario.via_principal_clave =
      dto.via_principal_clave ?? usuario.via_principal_clave;
    usuario.via_principal_valor =
      dto.via_principal_valor ?? usuario.via_principal_valor;
    usuario.via_secundaria_clave =
      dto.via_secundaria_clave ?? usuario.via_secundaria_clave;
    usuario.via_secundaria_valor =
      dto.via_secundaria_valor ?? usuario.via_secundaria_valor;
    usuario.tipo_unidad_uno_clave =
      dto.tipo_unidad_uno_clave ?? usuario.tipo_unidad_uno_clave;
    usuario.tipo_unidad_uno_valor =
      dto.tipo_unidad_uno_valor ?? usuario.tipo_unidad_uno_valor;
    usuario.tipo_unidad_dos_clave =
      dto.tipo_unidad_dos_clave ?? usuario.tipo_unidad_dos_clave;
    usuario.tipo_unidad_dos_valor =
      dto.tipo_unidad_dos_valor ?? usuario.tipo_unidad_dos_valor;
